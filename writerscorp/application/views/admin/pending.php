                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">In Progress</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                                            ...
                                                            else
                                                            {
                                                             ...
                                                             <!--   <td><a href="<?php // echo base_url('admin/submit_paper/').$row->order_id; ?>"><button class="btn btn-warning btn-sm">Submit Work</button></a></td> -->
                                                              ...
                                                              <?php
                                                                ...
                                                                <td><a href="#myModal<?php echo $row->order_id ?>" data-target="#myModal<?php echo $row->order_id ?>" data-toggle="modal"><button class="btn btn-warning btn-sm">Action</button></a></td>
