                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Technical Orders</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                                      ...
                                                      <?php
                                                          ...
                                                          <tr>
                                                              ...
                                                              <?php if($row->order_technical_status==0) { ?>
                                                               ...
                                                               <td><a href="#myModal<?php echo $row->order_id;  ?>" data-toggle="modal" data-target="#myModaly<?php echo $row->order_id;  ?>"><button class="btn btn-success btn-sm">Send Quotation</button></a></td>
